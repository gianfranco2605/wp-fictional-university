            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    <!-- <?php
                            ...
                            ?> -->
                    <ul>
                        <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 13) echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/about-us')  ?>">About Us</a>
                ...
                <div class="site-header__util">
                    <a href="<?php echo esc_url(site_url('/my-notes-block')) ?>" class="btn btn--small btn--orange float-left push-right">My Notes Block</a>
